...
const NavBar = () => {
    ...
    */
    ...
    switch(LoggedAs){
        case "student":
            return(
                <Navbar className='Navbar' bg={DarkTheme?"dark":"light"} variant={DarkTheme?"dark":"light"} >
                ...
                <Navbar.Collapse id="navbarScroll">
                  ...
                  <Nav>
                    <Button id="themes" onClick={()=>{ToggleTheme(!DarkTheme)}} >{DarkTheme?"LIGHT THEME":"DARK THEME"}</Button>        
                    <div className='divPad-small'/>
                    <Button id="profile" ><Nav.Link href='/profile'>Profile</Nav.Link></Button> 
                    <div className='divPad'/>  
                </Nav>     
                </Navbar.Collapse>
            </Navbar>
